...
class MyTestCase(unittest.TestCase):
    ...
    def test_black_pawn_move(self):
        self.assertFalse(pawn.BlackPawn(0, 0).move(b))
        self.assertFalse(pawn.BlackPawn(2, 0).move(b))
        self.assertFalse(pawn.BlackPawn(11, 0).move(b))
        result = [5, 5, 6, 5]
        self.assertEqual(pawn.BlackPawn(5, 5).move(b), result)
        result = [3, 5, 5, 5]
        self.assertEqual(pawn.BlackPawn(3, 5).move(b), result)

    def test_white_pawn_move(self):
        self.assertFalse(pawn.WhitePawn(15, 15).move(b))
        self.assertFalse(pawn.WhitePawn(13, 0).move(b))
        self.assertFalse(pawn.WhitePawn(4, 0).move(b))
        result = [12, 5, 10, 5]
        self.assertEqual(pawn.WhitePawn(12, 5).move(b), result)
        result = [7, 5, 6, 5]
        self.assertEqual(pawn.WhitePawn(7, 5).move(b), result)

    def test_black_horse_move(self):
        self.assertFalse(horse.BlackHorse(0, 0).move(b))
        self.assertFalse(horse.BlackHorse(1, 8).move(b))
        self.assertFalse(horse.BlackHorse(0, 15).move(b))
        result = [2, 2, 4, 1]
        self.assertEqual(horse.BlackHorse(2, 2).move(b), result)
        result = [8, 8, 10, 7]
        self.assertEqual(horse.BlackHorse(8, 8).move(b), result)
        result = [11, 15, 9, 14]
        self.assertEqual(horse.BlackHorse(11, 15).move(b), result)

    def test_white_horse_move(self):
        self.assertFalse(horse.WhiteHorse(15, 15).move(b))
        self.assertFalse(horse.WhiteHorse(14, 8).move(b))
        self.assertFalse(horse.WhiteHorse(15, 0).move(b))
        result = [13, 13, 11, 12]
        self.assertEqual(horse.WhiteHorse(13, 13).move(b), result)
        result = [8, 8, 10, 7]
        self.assertEqual(horse.WhiteHorse(8, 8).move(b), result)
        result = [4, 0, 6, 1]
        self.assertEqual(horse.WhiteHorse(4, 0).move(b), result)
    ...
    def test_white_rook_attack(self):
        ...
        result = [['k', 2, 8, 1, 8], ['p', 2, 8, 3, 8], ['p', 2, 8, 2, 7],
                  ['p', 2, 8, 2, 9]]
    ...
    def test_black_queen_attack(self):
        ...
        result = [['Q', 13, 6, 14, 7], ['B', 13, 6, 14, 5], ['P', 13, 6, 12, 7],
                  ['P', 13, 6, 12, 5], ['Q', 13, 6, 14, 6], ['P', 13, 6, 12, 6],
                  ['P', 13, 6, 13, 5], ['P', 13, 6, 13, 7]]
